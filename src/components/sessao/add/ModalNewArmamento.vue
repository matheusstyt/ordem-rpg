  ...
  <div class="novo-armamento">
    ...
    <div class="container-add-armamentos">
      ...
      <div class="input-field">
        ...
        <input
          type="text"
          name="espaco_armamento"
          v-model="espaco_armamento"
          id="espaco_armamento"
        />
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    post_armamentos(id) {
      ...
      axios
        .post(url, body_atributos, { headers: headers })
        .then((res) => {
    ...
    salvar_armamento_user(id) {
      ...
      axios
        .post(url, body_armamento_user, { headers: headers })
        .then((res) => {})
        .catch((error) => {
          console.log(error);
        });
...
.input-field input[type="search"]:active {
  outline: none;
  border: none;
}
.content-ico {
