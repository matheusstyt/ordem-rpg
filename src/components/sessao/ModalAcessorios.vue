...
export default {
    ...
    methods:{
        ...
        get_acessorios(){
            ...
            const url = "http://192.168.100.52:8000/acessoriosSession/";
        ...
        get_acessorio(id) {
            const headers = {'Authorization': 'Token ' + sessionStorage.getItem('token') };
            const url = "http://192.168.100.52:8000/acessorioSession/";
        ...
        delete_acessorios(id){
            ...
            this.acessorios_session.forEach(acessorios => {
                ...
                if( id === acessorios.fk_acessorio ){
                    const headers = {'Authorization': 'Token ' + sessionStorage.getItem('token') };
                    const url = `http://192.168.100.52:8000/acessorios/${acessorios.id}/`;
