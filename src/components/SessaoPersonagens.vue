    ...
    <div class="conteiner-a">
      ...
      <div class="containerJogadores">
        <ul>
          ...
          <li
            v-for="(jogador, index) in dadosa"
            :key="index"
            @click="AbrirJogador(jogador)"
          >
              ...
              <div id="box-barra-padrao">
                ...
                <div class="barraVida barraP">
                  <div class="barra-vida barra-p" :style="listVida[index]">
                    <p class="contagemBarra" id="contagemVida">
                      {{ jogador.atual_v }}/{{ jogador.maximo_v }}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div style="display: flex">
                  <div class="barraSanidade barraP">
                    <div class="barra-sanidade barra-p" :style="listSanidade[index]">
                      <p class="contagemBarra">
                        {{ jogador.atual_s }}/{{ jogador.maximo_s }}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div id="box-barra-padrao">
                ...
                <div class="barraEsforco barraP">
                  <div class="barra-esforco barra-p" :style="listEsforco[index]">
                    <p class="contagemBarra">
                      {{ jogador.atual_e }}/{{ jogador.maximo_e }}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="container-chat">
        ...
        <div class="caixa-message">
          ...
          <div class="messagem">
            ...
            <!-- <h3></h3> -->
            <p>
              matheus(Joaquin): minha mensagem asdasdasdaskd asdasdasda asdasdas vasdasdas
...
#modal-g {
  display: grid;
  grid-template-areas: "ladoA ladoA ladoA ladoA ladoB";
  width: 100%;
}
.caixa-personagem H2 {
  text-align: center;
